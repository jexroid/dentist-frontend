        ...
        <div className='container'>
          <div className='row'>
            <div className='col-xl-4 d-flex flex-column justify-content-center'>
              <h1 data-aos='fade-up'>روی آنچه مهم است تمرکز کنید</h1>
              <figure>
        ...
        <div className='container'>
          <div className='row g-0'>
            ...
            <div className='col-xl-5 img-bg' data-aos='fade-up' data-aos-delay={100}>
              <img alt='چرا ما' src='./img/BANER2.png' />
            </div>
            {/* سویپر سمت راست */}
              ...
              <div className='swiper-container'>
                <div className='swiper-wrapper'>
                  ...
                  <div className='swiper-slide'>
                    <div className='item'>
                      <h3 className='mb-3'>بیایید کسب و کار خود را با هم توسعه دهیم</h3>
                      <h4 className='mb-3'>متن از پیش ساخته شده پیش فرض</h4>
                      <p>متن از پیش ساخته شده پیش فرض</p>
                    </div>
                  </div>
                  {/* آیتم دوم */}
                  <div className='swiper-slide'>
                    <div className='item'>
                      <h3 className='mb-3'>از آنجا می بینید که درد را دفع می کند</h3>
                      <h4 className='mb-3'>زیرا لذت و درد یکی هستند...</h4>
                      <p>درد چون پرواز لذت را به دنبال دارد. هیچ عاقبتی از آن‌ها وجود ندارد...</p>
                    </div>
                  </div>
                  {/* آیتم سوم */}
                  <div className='swiper-slide'>
                    <div className='item'>
                      <h3 className='mb-3'>چیزی که کمتر نیست</h3>
                      <h4 className='mb-3'>دردهای حاصل از لذت‌های زندگی...</h4>
                      <p>نه لذت‌ها. آن‌ها آن را شل یا شفاف می‌گذارند...</p>
                    </div>
                  </div>
                  {/* آیتم چهارم */}
                  <div className='swiper-slide'>
                    <div className='item'>
                      <h3 className='mb-3'>او به اقتضای برخی می‌پردازد و نه لذت</h3>
                      <h4 className='mb-3'>زمان‌هایی که به این دلیل است که...</h4>
                      <p>به عنوان چیزها و اما یا و همه چیز ممکن است دردسرساز شود...</p>
                    </div>
                  </div>
                </div>
          ...
          <div className='row'>
            ...
            <div className='col-lg-5 position-relative' data-aos='zoom-out' data-aos-delay={200}>
              <div className='phone-wrap'>
                <img alt='iphone' className='img-fluid' src='/img/iphone.png' />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className='col-xl-3 col-md-6' data-aos='fade-up' data-aos-delay={600}>
              <div className='post-box'>
                ...
                <div className='post-content'>
                  ...
                  <p>
                    زیرا هر کس که برای او توضیح دهم، او و امثال آن را سخت طلب خواهد کرد. چه کسی همه را دفع می کند اما چه
                    چیزی بزرگ را به دنبال خواهد داشت...
                  </p>
                  <a className='readmore stretched-link' href='blog-details.html'>
                    <span>بخوانید</span>
                    <i className='bi bi-arrow-right' />
            ...
            <div className='col-xl-3 col-md-6' data-aos='fade-up' data-aos-delay={800}>
              <div className='post-box'>
                ...
                <div className='post-content'>
                  ...
                  <p>
                    و نتیجه حاصل خواهد شد، زیرا لذت راحتی همان چیزی است که از آن حاصل می شود. یا همه آنها به دلیل انتخاب
                    چه کسانی هستند ...
                  </p>
                  <a className='readmore stretched-link' href='blog-details.html'>
                    <span>بخوانید</span>
